...
namespace FinalOOPtr
{
    ...
    public class Teacher:Employee
    {
        ...
        public static double TEACHER_HOUR_SALARY { get; set; } = 70;

        //קונסטרקטור מלא
        public Teacher(string fullName, string address, string email, double workHoursInMunth):base(fullName, address, email, workHoursInMunth)
        {
        }


        //פעולת טו-סטרינג המחזירה מחרוזת "אני מורה"
        ...
        {
            return base.WorkHoursInMunth * TEACHER_HOUR_SALARY;
        }
        ...
        {
            return base.WorkHoursInMunth * TEACHER_HOUR_SALARY + bonos;
        }
    }
}
